...
public:
	...
	void setUid(unsigned int pUid) { uid_ = pUid; }
	void setActive(bool pIsActive) { isActive_ = pIsActive; }
	void setUserSerial(unsigned int pUserSerial) { userSerial_ = pUserSerial; }
	...
	int				getUserSerial() const	{ return userSerial_;	}
	const char*		getUserNick()	const	{ return userNick_;		}
